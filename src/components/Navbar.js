...
let Navbar  = () => {
  ...
  return (
        <div className="absolute w-full z-500 bg-transparent top-0 lg:px-16 px-6 flex flex-wrap items-center lg:py-0 py-2">
          ...
          <input className="hidden" type="checkbox" id="menu-toggle" onClick={toggle}/>

          
 
                  {/* <animated.div style={fade}> */}
                  <div className="lg:flex lg:items-center lg:w-auto w-full sm:hidden xs:hidden md:hidden" id="menu">
                    <nav>
                      <ul className="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
                        <li><a className="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="#">Portfolio</a></li>
                        <li><a className="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="#">Projects</a></li>
                        <li><a className="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="#">Skills</a></li>
